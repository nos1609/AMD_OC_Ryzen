...
The GPU SSDT files, such as _SSDT-X570-RX580-slot-1.aml_, primarily provide correct re-naming of the devices (although much is provided by WEG) and nice displays of the drivers within SystemInformaion/PCI on the Mac. Most of these inject PowerPlayTable data, which undervolts and overclocks the dGPUs: 5700XT, Radeon VII, Vega 56 and 64. The functioning of these graphics cards is further enhanced by the RadeonBooster kext as discussed in the Intro.
